 ...
 */
public class HorizontalListAdapter extends SingleDataListAdapter<NovationByTopicVo.FilterDirectionsEntity> {

    private int selectPosition;

    public HorizontalListAdapter(List<NovationByTopicVo.FilterDirectionsEntity> data, Context context) {
        super(data, context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == selectPosition) {
            ...
            if (position == 0) {
                ...
                tv.setPadding(otherPaddingLeft,paddingTopLess,firstPaddingLeft,0);
            } else {
            ...
            if (position == 0) {
                ...
                tv.setPadding(otherPaddingLeft,paddingTop,firstPaddingLeft,0);
            }else{
