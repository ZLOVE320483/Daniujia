...
public abstract class ShaderHelper {
    ...
    public ShaderHelper() {
        /**
         *  initialization of the two pen a painting boundary a drawing another
         */
     ...
     * @param imagePaint
     * @param borderPaint
     *      three abstract determine your image like;
     */
     ...
     * @param defStyle
     *
     *  initialization the  custom properties
     */
        ...
        if(bitmap != null) {
            ...
            if(bitmapWidth > 0 && bitmapHeight > 0) {
                ...
                if (bitmapWidth < bitmapHeight) {
                    bitmap = BitmapUtil.zoomImage(bitmap, bitmapWidth, 9f/10 * bitmapHeight);
