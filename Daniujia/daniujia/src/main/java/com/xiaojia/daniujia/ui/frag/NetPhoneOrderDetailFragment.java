 ...
 */
public class NetPhoneOrderDetailFragment extends BaseFragment implements View.OnClickListener, TextWatcher {
    ...
    private RelativeLayout calculateBoard;
    private Button add;
    ...
    protected int getInflateLayout() {
        return R.layout.phone_order_detail_fg;
    }
    ...
    protected void setUpView(View view) {
        ...
        count = (TextView) view.findViewById(R.id.time_count);
        ...
        calculateBoard = (RelativeLayout) view.findViewById(R.id.calculate_board);
        ...
        tvPerPrice.setText(perPrice + "元/分钟");
        tvTotalPrice.setText(SysUtil.formatFloatNum(Float.parseFloat(perPrice) * 30));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_title_more:
                ...
                dlg.initDlg(R.drawable.ic_question_blue, "电话约谈", indicatorContent);
                dlg.show();
                break;
            ...
            case R.id.add:
                ...
                count.setText(countNum + 5 + "");
                break;
            case R.id.reduce:
                int countNum2 = Integer.parseInt(count.getText().toString());
                if (countNum2 == 30) {
                    return;
                }
                count.setText(countNum2 - 5 + "");
                break;
            case R.id.refund:
    ...
    private void requestOrder() {
        int orderTime = Integer.parseInt(count.getText().toString());
...
//                }
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (countNum == 30) {
            calculateBoard.setEnabled(true);
        } else {
            calculateBoard.setEnabled(false);
        }
        if (!TextUtils.isEmpty(perPrice))
            tvTotalPrice.setText(SysUtil.formatFloatNum(countNum * Float.parseFloat(perPrice)));
    }
