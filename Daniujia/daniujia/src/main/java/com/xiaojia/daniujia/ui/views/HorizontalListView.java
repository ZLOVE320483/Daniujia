...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    public void setSelection(int position) {
        ...
        for (int i = 0; i < position; i++) {
            ...
            if (view != null) {
                positionX += view.getWidth();
            } else {
//                final int temp = 0;
//                positionX += getAdapter().getView(i,null,null).getWidth();
            ...
            Log.d("zptest", "positionX: " + positionX);
        }
        if (positionX <= 0) {
            positionX = 0;
        }
    ...
    public void moveToDestination(int position) {
        int destination = 0;
        for (int i = 0; i < position; i++) {
            if (mAdapter instanceof HorizontalListAdapter || mAdapter instanceof HorizontalListAdapterIndustry) {
                NovationByTopicVo.FilterDirectionsEntity entity = (NovationByTopicVo.FilterDirectionsEntity) (mAdapter.getItem(i));
                ...
                if (position == 0) {
                    destination += (width + ScreenUtils.dip2px(16));
                } else {
                    destination += (width + ScreenUtils.dip2px(30));
                }
            }
