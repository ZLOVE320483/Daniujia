 ...
 */
public class AskRewardFinishedFragment extends BaseFragment implements XListView.IXListViewListener, AdapterView.OnItemClickListener {
    ...
    protected void setUpView(View view) {
        ...
        adapter = new AskRewardListAdapter(items, getActivity(), true);
    ...
    private void requestData() {
        String url = Config.WEB_API_SERVER_V3 + "/reward/questions?type=expired&cursor=" + cursor;
    ...
    private void refreshData(AskRewardListRespVo result) {
        ...
        List<AskRewardListRespVo.AskRewardListItem> tmpList = result.getExpiredQuestions().getItems();
        if (tmpList.size() < 10) {
        ...
        cursor = result.getExpiredQuestions().getNextCursor();
