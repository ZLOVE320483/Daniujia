 ...
 */
public class GridViewTagSpaceAdapter extends SingleDataListAdapter<NovationByTopicVo.FilterDirectionsEntity>{
    int selection = 0;
    public GridViewTagSpaceAdapter(List<NovationByTopicVo.FilterDirectionsEntity> data, Context context) {
        super(data, context);
    }
    @Override
