 ...
 */
public class MyExpertWaitToCommentFragment extends BaseFragment implements AdapterView.OnItemClickListener, XListView.IXListViewListener {
    ...
    private void refreshData(MyAppointExpert result) {
        ...
        if (result == null) {
            ...
            tvNoDataTip.setText("您还没有待评价的约谈信息");
            return;
        } else {
    ...
    private void requestData() {
        String url = Config.WEB_API_SERVER_V3 + "/user/order/my/list/" + SysUtil.getIntPref(PrefKeyConst.PREF_USER_ID) + "/2/" + pageNum;
