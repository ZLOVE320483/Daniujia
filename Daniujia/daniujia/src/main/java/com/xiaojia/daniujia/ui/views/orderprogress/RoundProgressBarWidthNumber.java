package com.xiaojia.daniujia.ui.views.orderprogress;
...
public class RoundProgressBarWidthNumber extends HorizontalProgressBarWithNumber {
	...
	protected void onDraw(Canvas canvas) {
		String text;
		float textWidth;
		LogUtil.d("zptest","progress: "+getProgress());
		if (getMax() > 10){
			text = "10";
	...
	public void setShowTest(boolean isShow){
		isShowTest = isShow;
	}

	public void setRadiusWidth(int mRadiusWidth) {
