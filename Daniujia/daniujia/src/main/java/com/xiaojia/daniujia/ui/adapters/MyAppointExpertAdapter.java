 ...
 */
public class MyAppointExpertAdapter extends SingleDataListAdapter<MyAppointExpert.OrdersEntity> {

    public MyAppointExpertAdapter(List<MyAppointExpert.OrdersEntity> data, Context context) {
        super(data, context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.list_item_my_expert_new, null);
        ...
        if (item != null) {
            ...
            viewHolder.position.setText(item.getPosition() + " | " + item.getCompany());
            ...
            if (serviceType == 1) {
                ...
                viewHolder.time.setText("共计: " + item.getServiceCnt() + " 分钟");
                ...
                viewHolder.time.setVisibility(View.VISIBLE);
                viewHolder.time.setText("共计: " + item.getServiceCnt() + " 小时");
                viewHolder.tvHasCall.setVisibility(View.GONE);
            }
    ...
    class ViewHolder{
        ...
        public ViewHolder(View convertView) {
            ...
            position = (TextView) convertView.findViewById(R.id.position_corp);
            ...
            containerView = convertView.findViewById(R.id.order_container);
