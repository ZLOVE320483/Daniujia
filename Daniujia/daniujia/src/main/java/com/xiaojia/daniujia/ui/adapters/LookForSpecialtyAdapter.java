 ...
 */
public class LookForSpecialtyAdapter extends SingleDataListAdapter<SearchDataEntity.Directions>{

    public LookForSpecialtyAdapter(List<SearchDataEntity.Directions> data, Context context) {
        super(data, context);
    }
