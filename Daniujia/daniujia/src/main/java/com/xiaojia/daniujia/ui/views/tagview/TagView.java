package com.xiaojia.daniujia.ui.views.tagview;
...
public class TagView extends RelativeLayout {
	...
	private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
		...
		this.lineMargin = (int) typeArray.getDimension(R.styleable.TagView_lineMargin, ScreenUtils.dip2px(Constants.DEFAULT_LINE_MARGIN));
		this.tagMargin = (int) typeArray.getDimension(R.styleable.TagView_tagMargin, ScreenUtils.dip2px(Constants.DEFAULT_TAG_MARGIN));
		this.textPaddingLeft = (int) typeArray.getDimension(R.styleable.TagView_textPaddingLeft, ScreenUtils.dip2px(Constants.DEFAULT_TAG_TEXT_PADDING_LEFT));
		this.textPaddingRight = (int) typeArray.getDimension(R.styleable.TagView_textPaddingRight, ScreenUtils.dip2px(Constants.DEFAULT_TAG_TEXT_PADDING_RIGHT));
		this.textPaddingTop = (int) typeArray.getDimension(R.styleable.TagView_textPaddingTop, ScreenUtils.dip2px(Constants.DEFAULT_TAG_TEXT_PADDING_TOP));
		this.texPaddingBottom = (int) typeArray.getDimension(R.styleable.TagView_textPaddingBottom, ScreenUtils.dip2px(Constants.DEFAULT_TAG_TEXT_PADDING_BOTTOM));
		typeArray.recycle();
	}
	...
	private void drawTags() {
		...
		for (Tag item : mTags) {
			...
			if (tag.isDeletable) {
				...
				int offset = ScreenUtils.dip2px(2f);
			...
			if (mWidth <= total + tagWidth + ScreenUtils.dip2px(Constants.LAYOUT_WIDTH_OFFSET)) {
	...
	private Drawable getSelector(Tag tag) {
		...
		if (tag.layoutBorderSize > 0) {
			gd_normal.setStroke(ScreenUtils.dip2px(tag.layoutBorderSize), tag.layoutBorderColor);
		}
	...
	public void setLineMargin(float lineMargin) {
		this.lineMargin = ScreenUtils.dip2px(lineMargin);
	}
	...
	public void setTagMargin(float tagMargin) {
		this.tagMargin = ScreenUtils.dip2px(tagMargin);
	}
	...
	public void setTextPaddingLeft(float textPaddingLeft) {
		this.textPaddingLeft = ScreenUtils.dip2px(textPaddingLeft);
	}
	...
	public void setTextPaddingRight(float textPaddingRight) {
		this.textPaddingRight = ScreenUtils.dip2px(textPaddingRight);
	}
	...
	public void setTextPaddingTop(float textPaddingTop) {
		this.textPaddingTop = ScreenUtils.dip2px(textPaddingTop);
	}
	...
	public void setTexPaddingBottom(float texPaddingBottom) {
		this.texPaddingBottom = ScreenUtils.dip2px(texPaddingBottom);
	}
