...
public abstract class OnekeyShareThemeImpl implements PlatformActionListener, Callback {
	...
	public final boolean handleMessage(Message msg) {
		LogUtil.d("ZLOVE", "handleMessage---msg---" + msg.what + "---" + msg.obj);
		switch (msg.arg1) {
			case 1: {
				// 成功
				...
				McMsg mcMsg = McMsg.newInstance(InsideMsg.NOTIFY_SHARE_STATUS, 1);
			...
			case 2: {
				...
				McMsg mcMsg = McMsg.newInstance(InsideMsg.NOTIFY_SHARE_STATUS, 2);
				MsgHelper.getInstance().sendMsg(mcMsg);
			}
			break;
			case 3: {
				...
				McMsg mcMsg = McMsg.newInstance(InsideMsg.NOTIFY_SHARE_STATUS, 3);
				MsgHelper.getInstance().sendMsg(mcMsg);
			}
			break;
		}
