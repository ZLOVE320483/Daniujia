...
public class ThemeConfig implements Serializable{
    ...
    private ThemeConfig(Builder builder) {
        ...
        this.checkNornalColor = builder.checkNormalColor;
        this.checkSelectedColor = builder.checkSelectedColor;
        this.fabNornalColor = builder.fabNormalColor;
    ...
    public static class Builder {
        private int titleBarTextColor = Color.parseColor("#333333");
        private int titleBarBgColor = Color.parseColor("#fafafa");
        private int titleBarIconColor = Color.parseColor("#888888");
        private int checkNormalColor = Color.parseColor("#888888");
        private int checkSelectedColor = Color.parseColor("#2594e9");
        private int fabNormalColor = Color.parseColor("#2594e9");
        private int fabPressedColor = Color.parseColor("#2594e9");
        private int cropControlColor =  Color.parseColor("#2594e9");
